...
var snowStorm = (function ( window, document ) {
	...
	var s = this, storm = this, i,
		...
		screenX = null, screenX2 = null,
		screenY = null, scrollY = null,
		vRndX = null, vRndY = null, windOffset = 1,
		windMultiplier = 2, flakeTypes = 6,
	...
	this.SnowFlake = function ( parent, type, x, y ) {
		...
		this.refresh = function () {
			...
			//s.o.style.WebkitTransform="rotate("+deg+"deg)";
			//s.o.style.WebkitTransform="skew("+deg1+"deg)";
			s.o.style.WebkitTransform = "matrix(1," + ma + "," + ma + ",1,0,0)";
			deg += 6;
			deg1 += deg1a;
			ma += maa;
			if ( deg > 360 ) {
